    ...
    <footer className="bg-ink-black text-slate pt-20 pb-10">
      ...
      <div className="container flex flex-col md:flex-row items-center md:justify-between gap-4 pt-8 text-[13px] text-white/30">
        ...
        <div className="flex gap-5">
          ...
          <a href="#" aria-label="X / Twitter" className="text-white/30 transition-all duration-200 hover:text-signal-mint hover:-translate-y-0.5">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
              <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
            </svg>
          </a>
          <a href="#" aria-label="Instagram" className="text-white/30 transition-all duration-200 hover:text-signal-mint hover:-translate-y-0.5">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
